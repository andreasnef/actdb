...
module.exports = {
    ...
    updateLocation: function(profile, form, relEvents, relSites, relLocations, relMPs, contacts, sources, groups){
        ...
        if ((profile.location.latitude!= form.location_latitude && form.location_latitude != "") || (profile.location.longitude!= form.location_longitude) && form.location_longitude!= "") {
