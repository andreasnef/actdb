...
var style_sites_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_sites_1(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (sites_1rule0_eval_expression(context)) {
        ...
        var style = rules_sites_1(feature, value);
        ;
...
function update() {
    ...
    var features = lyr_sites_1.getSource().getFeatures();
