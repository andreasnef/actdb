...
var style_events_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_events_0(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (events_0rule0_eval_expression(context)) {
        ...
        var style = rules_events_0(feature, value);
        ;
...
function update() {
    ...
    var features = lyr_events_0.getSource().getFeatures();
